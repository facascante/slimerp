#
# $Header: svn://svn/SWM/trunk/web/techadmin/MemberCardAdmin.pm 8251 2013-04-08 09:00:53Z rlee $
#
  ...
  while (my $dref = $query->fetchrow_hashref()) {
    ...
    $body .= qq[
      <tr>
        ...
        <td class="$classborder">[<a $extralink href="$target?action=MC_form&amp;mcID=$dref->{intMemberCardConfigID}">Edit</a>]</td>
      </tr>
    ];
  }
  if(!$body)  {
    ...
    $body = qq[
    <p><a href="$target?action=MC_form">Add New Card</a> | <a href="$target?action=MC_list_templates">List Templates</a></p>
  ...
  while (my $dref = $query->fetchrow_hashref()) {
    ...
    $body .= qq[
      <tr>
        ...
        <td class="$classborder">[<a $extralink href="$target?action=MC_form_templates&amp;mcID=$dref->{intMemberCardTemplateID}">Edit</a>]</td>
      </tr>
    ];
  }
  if(!$body)  {
    $body .= qq[
    <p><a href="$target?action=MC_form_templates">Add New Template</a></p>
    <table cellpadding="1" cellspacing="0" border="0" width="90%" align="center">
      <tr>
