#
# $Header: svn://svn/SWM/trunk/web/finder/FinderDefs.pm 10144 2013-12-03 21:36:47Z tcourt $
#
...
%Settings = (
  $REALM_DEFAULT => {
    ...
    DefaultHeader => 'default_search_hdr.jpg',
    DefaultCopyright => '&copy Copyright SportingPulse (ANZ) Pty Ltd 2010. All rights reserved.',
  },
  $REALM_RUGBY_LEAGUE => {
