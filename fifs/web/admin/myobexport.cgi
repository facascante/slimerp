...
#
# $Header: svn://svn/SWM/trunk/web/admin/myobexport.cgi 10072 2013-12-01 22:57:03Z tcourt $
#
...
sub getOptions {
    ...
    my $body = qq[
        <form action="$target" method="post">
            ...
            <input type="radio" name="paymentType" id="rbPaypal" value="PAYPAL_NAB" class="ROnb" checked><label for="rbPaypal"> Paypal </label>
...
sub buildDoc {
	...
	my $sql = qq[
        	...
        	WHERE
					TL.intPaymentType IN ($Defs::PAYMENT_ONLINEPAYPAL)
