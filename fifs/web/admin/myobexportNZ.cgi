...
#
# $Header: svn://svn/SWM/trunk/web/admin/myobexportNZ.cgi 10076 2013-12-01 22:59:43Z tcourt $
#
...
<br>
            <label class="label": for "txtNZRate">NZ Rate:</label><input type="text" name="nzrate" id="txtNZRate" value="0.6">
...
sub buildDoc {
    ...
    my $NZRate= param("nzrate")         || 0;

    return getErrorMessage() if !$NZRate;
...
$doc.= "\n";
    ...
    my $body = qq[
        ...
        <form action ="$target" method="POST">
            ...
            <input type="hidden" name="nzrate" value="$NZRate">
...
sub doExport {
    ...
    my $message  = "The NZ data you requested for export is included in the attached file ($filename)" ;
    my $subject  = "NZD Data Export - Payment Split Fees";
    ...
    if ($retval == 0) {
...

        {
            ...
            my $subject  = "NZD Data Export - Customer List";
        ...
        }
	{
            ...
            my $message  = "The customer list for export ID $myobExportID is included in the attached file ($filename)" ;
            my $subject  = "NZD Data Export - PayPal Fees";
