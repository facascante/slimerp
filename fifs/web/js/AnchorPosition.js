...
// MARTIN: if a second function argument is true then we want WINDOW coordinates
...
if (wincoord) {
x = AnchorPosition_getWindowOffsetLeft(document.all[anchorname]);
y = AnchorPosition_getWindowOffsetTop(document.all[anchorname]);
}
else {
...
var coordinates = getAnchorPosition(anchorname, true);
var x=0;
var y=0;
